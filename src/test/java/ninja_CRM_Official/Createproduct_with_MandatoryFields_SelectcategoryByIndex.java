...
public class Createproduct_with_MandatoryFields_SelectcategoryByIndex {
	...
	public static void main(String[] args) throws IOException {
		...
		//data from Excel file 
		 String productname = excelutilFile.getExcelUtilityFile("createProduct", 7, 2);
		 String productcategory = excelutilFile.getExcelUtilityFile("createProduct", 7, 3);
		 int productcategoryIndex = Integer.parseInt(productcategory);
		 String productQuantity = excelutilFile.getExcelUtilityFile("createProduct", 7, 4);
		 String productPricePerUnit = excelutilFile.getExcelUtilityFile("createProduct", 7, 5);
		 String productvendor = excelutilFile.getExcelUtilityFile("createProduct", 7, 6);
		...
		addProductpagePOM.getProductNameTf().sendKeys(productname+"_"+Jlib.generateThreeDigitNum());
		 ...
		 webdriverutility.select(productCategoryDropdwon,productcategoryIndex );
		...
		webdriverutility.select(VendorDropdwon,productvendorIndex);
