...
public class CreateProduct_with_Quantity {
	...
	public static void main(String[] args) throws IOException {
		...
		//data from Excel file 
		 String productname = excelutilFile.getExcelUtilityFile("createProduct", 19, 2);
		 String productcategory = excelutilFile.getExcelUtilityFile("createProduct", 19, 3);
		 String productQuantity = excelutilFile.getExcelUtilityFile("createProduct", 19, 4);
