...
public class Createproduct_with_MandatoryFields {
	...
	public static void main(String[] args) throws IOException {
		...
		//data from Excel file 
		 String productname = excelutilFile.getExcelUtilityFile("createProduct", 1, 2);
		 String productcategory = excelutilFile.getExcelUtilityFile("createProduct", 1, 3);
		 String productQuantity = excelutilFile.getExcelUtilityFile("createProduct", 1, 4);
		 String productPricePerUnit = excelutilFile.getExcelUtilityFile("createProduct", 1, 5);
		 String productvendor = excelutilFile.getExcelUtilityFile("createProduct", 1, 6);
