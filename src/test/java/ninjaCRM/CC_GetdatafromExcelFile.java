...
public class CC_GetdatafromExcelFile {
	...
	public static void main(String[] args) throws IOException {
		...
		Cell secondcell = wb.getSheet("Sheet1").getRow(5).getCell(2);
		
		Cell campaignStatus = wb.getSheet("Sheet1").getRow(5).getCell(3);
		
		Cell targetSizes = wb.getSheet("Sheet1").getRow(5).getCell(4);
		
		Cell expectdate = wb.getSheet("sheet1").getRow(5).getCell(5);
		
		String expecteddateVal = expectdate.getStringCellValue();
		
		String secondcellval = secondcell.getStringCellValue();
		
		String campaignStatusVal = campaignStatus.getStringCellValue();
		...
		driver.findElement(By.xpath("//input[@name='campaignStatus']")).sendKeys(campaignStatusVal);
...
//		String requiredtime = sdf.format(cal.getTime());
		...
		driver.findElement(By.xpath("//input[@name='expectedCloseDate']")).sendKeys(expecteddateVal);
