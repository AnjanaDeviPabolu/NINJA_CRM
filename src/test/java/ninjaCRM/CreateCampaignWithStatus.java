...
//		driver.findElement(By.cssSelector("button[type='submit']")).click();
		...
		createcampaign_page.getCampaignNameTF().sendKeys("new campaign data");
		createcampaign_page.getTargetsizeTF().clear();
		createcampaign_page.getCampaignstatusTF().sendKeys("Inactive");
		createcampaign_page.getTargetsizeTF().sendKeys("10");
		createcampaign_page.getCreatecampaignBTn().click();
		
		//driver.findElement(By.xpath("//span[text()='Create Campaign']")).click();
		
//		driver.findElement(By.name("campaignName")).sendKeys("Newcampaign");
//		
