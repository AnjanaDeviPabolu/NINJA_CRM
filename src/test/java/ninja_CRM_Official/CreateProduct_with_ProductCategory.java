...
public class CreateProduct_with_ProductCategory {
	...
	public static void main(String[] args) throws IOException {
		...
		//data from Excel file 
		 String productname = excelutilFile.getExcelUtilityFile("createProduct", 16, 2);
		 String productcategory = excelutilFile.getExcelUtilityFile("createProduct", 16, 3);
